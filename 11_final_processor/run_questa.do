...
# QuestaSim/ModelSim batch flow for: Final RV32I Single-Cycle Processor
#
# Launch from any working directory with:
#     vsim -c -do 11_final_processor/run_questa.do
#
...
vsim -voptargs=+acc work.Single_Cycle_Top_tb
...
vcd file single_cycle_top.vcd
vcd add -r /Single_Cycle_Top_tb/*
