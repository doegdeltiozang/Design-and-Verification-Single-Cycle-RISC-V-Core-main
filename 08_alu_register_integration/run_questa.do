...
# QuestaSim/ModelSim batch flow for: ALU and Register Datapath Integration
#
# Launch from any working directory with:
#     vsim -c -do 08_alu_register_integration/run_questa.do
#
...
vsim -voptargs=+acc work.Integration_ALU_tb
...
vcd file integration_alu.vcd
vcd add -r /Integration_ALU_tb/*
