...
# QuestaSim/ModelSim batch flow for: Load/Store Datapath Integration
#
# Launch from any working directory with:
#     vsim -c -do 09_load_store_integration/run_questa.do
#
...
vsim -voptargs=+acc work.Integration_Load_Store_tb
...
vcd file integration_load_store.vcd
vcd add -r /Integration_Load_Store_tb/*
