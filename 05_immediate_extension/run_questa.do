...
# QuestaSim/ModelSim batch flow for: Immediate Reconstruction and Sign Extension
#
# Launch from any working directory with:
#     vsim -c -do 05_immediate_extension/run_questa.do
#
...
vcd file sign_extend.vcd
vcd add -r /Sign_Extend_tb/*
