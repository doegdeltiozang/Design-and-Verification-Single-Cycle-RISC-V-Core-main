...
# QuestaSim/ModelSim batch flow for: Main and ALU Control Decoders
#
# Launch from any working directory with:
#     vsim -c -do 07_control_unit/run_questa.do
#
...
vsim -voptargs=+acc work.Control_Unit_Top_tb
...
vcd file control_unit.vcd
vcd add -r /Control_Unit_Top_tb/*
